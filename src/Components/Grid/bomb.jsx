...
const Bomb = () => {
    useEffect(()=>{
        setTimeout(() => {
            alert("End Of the game! Please refresh the page for playing again");
        }, 1500);
    },[]);
    return (
        <svg fill="#ff0000" height="800px" width="800px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512" style={{
            position: 'absolute',
            top: '50%',
            left: '50%',
            width: '70%',
